...
<table class="form-table ppc-form-table">
	<tbody>
		...
		if ( ! empty( $ppc_checklist_item_data ) ) {
			...
			<?php
			foreach ( $ppc_checklist_item_data as $ppc_key ) {
				?>
									<li class="ppc-li">
										<!-- <span class = "down"></span> -->
										<span class="dashicons dashicons-menu-alt2 ppc-move-dashicon"></span> <input type="text" readonly="true" class="ppc-drag-feilds" value="<?php echo esc_attr( $ppc_key ); ?>" name="ppc_checklist_item[]" >
