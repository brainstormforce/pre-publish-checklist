$(document).ready(
    function() {
        ...
        //     var countCheckedppc_checkboxes = $ppc_checkboxes.filter(':checked');
            
        //     if(countCheckedppc_checkboxes.length !== 0 && $(this).prop("name") =="ppc-hide-checked-item" ){
                    
        //         countCheckedppc_checkboxes.each(function(){                
